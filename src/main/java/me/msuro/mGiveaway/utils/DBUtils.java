...
public class DBUtils {
    ...
    public void saveEntries(Giveaway giveaway) {
        ...
        try {
            ...
            for (String discordId : entries.keySet()) {
                String minecraftName = entries.get(discordId);
                statement.addBatch("INSERT OR REPLACE INTO `entries-" + giveaway.getName() + "` (discord_id, minecraft_name) VALUES ('" + discordId + "', '" + minecraftName + "');");
            }
